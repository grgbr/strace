...
# undef V4L2_CID_USER_IMX_BASE
 ...
 #define XLAT_VAL_11 ((unsigned) (V4L2_CID_MPEG_BASE))
 #define XLAT_STR_11 STRINGIFY(V4L2_CID_MPEG_BASE)
 XLAT(V4L2_CID_MPEG_CX2341X_BASE),
 #define XLAT_VAL_12 ((unsigned) (V4L2_CID_MPEG_CX2341X_BASE))
 #define XLAT_STR_12 STRINGIFY(V4L2_CID_MPEG_CX2341X_BASE)
 XLAT(V4L2_CID_MPEG_MFC51_BASE),
 #define XLAT_VAL_13 ((unsigned) (V4L2_CID_MPEG_MFC51_BASE))
 #define XLAT_STR_13 STRINGIFY(V4L2_CID_MPEG_MFC51_BASE)
 XLAT(V4L2_CID_CAMERA_CLASS_BASE),
 #define XLAT_VAL_14 ((unsigned) (V4L2_CID_CAMERA_CLASS_BASE))
 #define XLAT_STR_14 STRINGIFY(V4L2_CID_CAMERA_CLASS_BASE)
 XLAT(V4L2_CID_FM_TX_CLASS_BASE),
 #define XLAT_VAL_15 ((unsigned) (V4L2_CID_FM_TX_CLASS_BASE))
 #define XLAT_STR_15 STRINGIFY(V4L2_CID_FM_TX_CLASS_BASE)
 XLAT(V4L2_CID_FLASH_CLASS_BASE),
 #define XLAT_VAL_16 ((unsigned) (V4L2_CID_FLASH_CLASS_BASE))
 #define XLAT_STR_16 STRINGIFY(V4L2_CID_FLASH_CLASS_BASE)
 XLAT(V4L2_CID_JPEG_CLASS_BASE),
 #define XLAT_VAL_17 ((unsigned) (V4L2_CID_JPEG_CLASS_BASE))
 #define XLAT_STR_17 STRINGIFY(V4L2_CID_JPEG_CLASS_BASE)
 XLAT(V4L2_CID_IMAGE_SOURCE_CLASS_BASE),
 #define XLAT_VAL_18 ((unsigned) (V4L2_CID_IMAGE_SOURCE_CLASS_BASE))
 #define XLAT_STR_18 STRINGIFY(V4L2_CID_IMAGE_SOURCE_CLASS_BASE)
 XLAT(V4L2_CID_IMAGE_PROC_CLASS_BASE),
 #define XLAT_VAL_19 ((unsigned) (V4L2_CID_IMAGE_PROC_CLASS_BASE))
 #define XLAT_STR_19 STRINGIFY(V4L2_CID_IMAGE_PROC_CLASS_BASE)
 XLAT(V4L2_CID_DV_CLASS_BASE),
 #define XLAT_VAL_20 ((unsigned) (V4L2_CID_DV_CLASS_BASE))
 #define XLAT_STR_20 STRINGIFY(V4L2_CID_DV_CLASS_BASE)
 XLAT(V4L2_CID_FM_RX_CLASS_BASE),
 #define XLAT_VAL_21 ((unsigned) (V4L2_CID_FM_RX_CLASS_BASE))
 #define XLAT_STR_21 STRINGIFY(V4L2_CID_FM_RX_CLASS_BASE)
 XLAT(V4L2_CID_RF_TUNER_CLASS_BASE),
 #define XLAT_VAL_22 ((unsigned) (V4L2_CID_RF_TUNER_CLASS_BASE))
 #define XLAT_STR_22 STRINGIFY(V4L2_CID_RF_TUNER_CLASS_BASE)
 XLAT(V4L2_CID_DETECT_CLASS_BASE),
 #define XLAT_VAL_23 ((unsigned) (V4L2_CID_DETECT_CLASS_BASE))
 #define XLAT_STR_23 STRINGIFY(V4L2_CID_DETECT_CLASS_BASE)
};
