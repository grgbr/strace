...
static const struct xlat_data fan_event_flags_xdata[] = {
 ...
 XLAT(FAN_ONDIR),
 #define XLAT_VAL_17 ((unsigned) (FAN_ONDIR))
 #define XLAT_STR_17 STRINGIFY(FAN_ONDIR)
 XLAT(FAN_EVENT_ON_CHILD),
 #define XLAT_VAL_18 ((unsigned) (FAN_EVENT_ON_CHILD))
 #define XLAT_STR_18 STRINGIFY(FAN_EVENT_ON_CHILD)
};
static
