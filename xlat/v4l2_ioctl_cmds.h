...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((VIDIOC_QUERYBUF) == (_IOWR('V',   9, struct_v4l2_buffer)), "VIDIOC_QUERYBUF != _IOWR('V',   9, struct_v4l2_buffer)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define VIDIOC_QUERYBUF _IOWR('V',   9, struct_v4l2_buffer)
#endif
...
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((VIDIOC_QBUF) == (_IOWR('V',  15, struct_v4l2_buffer)), "VIDIOC_QBUF != _IOWR('V',  15, struct_v4l2_buffer)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define VIDIOC_QBUF _IOWR('V',  15, struct_v4l2_buffer)
#endif
#if defined(VIDIOC_DQBUF) || (defined(HAVE_DECL_VIDIOC_DQBUF) && HAVE_DECL_VIDIOC_DQBUF)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((VIDIOC_DQBUF) == (_IOWR('V',  17, struct_v4l2_buffer)), "VIDIOC_DQBUF != _IOWR('V',  17, struct_v4l2_buffer)");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define VIDIOC_DQBUF _IOWR('V',  17, struct_v4l2_buffer)
#endif
...
static const struct xlat_data v4l2_ioctl_cmds_xdata[] = {
 ...
 #define XLAT_VAL_34 ((unsigned) (VIDIOC_CREATE_BUFS))
 #define XLAT_STR_34 STRINGIFY(VIDIOC_CREATE_BUFS)
